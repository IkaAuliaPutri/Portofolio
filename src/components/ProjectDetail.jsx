...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/IkaAuliaPutri",
      };
  ...
  return (
    <>
      <Helmet>
        <title>{project.Title} — Ika Aulia Putri</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Ika Aulia Putri — Frontend Web Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Ika Aulia Putri`}
        />
        <meta
